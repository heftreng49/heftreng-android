...
- [x] Offline cache (Room + alıntılar) — `cached_quotes` (Room, `HeftrengDatabase`), Keşfet → Alıntılar başarıyla çekildiğinde önbelleğe yazılır; ağ hatası/çevrimdışıyken son 50 alıntı Room'dan gösterilir + "Çevrimdışısın" uyarısı.

                    ...
                    items(filtered, key = { it.id }) { conv ->
                        ...
                        Row(
                            modifier = Modifier
                                ...
                                .then(
                                    if (unread) Modifier.border(
                                        start = BorderStroke(3.dp, Primary)
                                    ) else Modifier
                                )
                            ...
                            modifier = Modifier.size(36.dp).clip(CircleShape)
                                .background(
                                    if (inputText.isNotBlank())
                                        Brush.linearGradient(listOf(Primary3, Primary))
            ...
            if (msg.replyToId.isNotBlank() && msg.replyToText.isNotBlank()) {
                Box(
                    modifier = Modifier
                        ...
                        .border(
                            start = BorderStroke(3.dp,
                                if (isMine) Color.White.copy(alpha = 0.5f) else Primary)
                        )
                ...
                modifier = Modifier
                    ...
                    .then(
                        ...
                        // Tema: .msg-bubble.deleted
                            ...
                            Modifier.background(Brush.linearGradient(listOf(Primary3, Primary)))
                        else
                            Modifier.background(Surface3).border(1.dp, Divider, RoundedCornerShape(

...
object Strings {
    ...
    fun undoRepostTitle(l: String) = t(l, "Repostu geri al",           "Ji nû ve parve kirinê betal bike")
    fun undoRepostBody(l: String)  = t(l, "Bu gönderi profilinden kaldırılacak.", "Ev nivîs ê ji profîla te were rakirin.")
    fun undoRepostConfirm(l: String) = t(l, "Geri Al",                  "Betal Bike")
    ...
    fun shareGrammarSuccess(l: String) = t(l, "Kural feed'de paylaşıldı!", "Rêziman li Feed'ê hate parvekirin!")

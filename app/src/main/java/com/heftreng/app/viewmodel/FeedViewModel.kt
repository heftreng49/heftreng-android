                ...
                viewModelScope.launch {
                    ...
                    _posts.value = snap.documents.mapNotNull { doc ->
                        ...
                        Post(
                            ...
                            chapterSnippet   = d["chapterSnippet"]     as? String ?: "",
                            serialCover      = d["serialCover"]        as? String ?: "",
                            serialBg         = d["serialBg"]           as? String ?: "",
                            chapterOrder     = (d["chapterOrder"]     as? Long)?.toInt() ?: 0,
                            chapterWordCount = (d["chapterWordCount"] as? Long)?.toInt() ?: 0,
        ...
        viewModelScope.launch {
            try {
                ...
                firestore.collection("feed").add(mapOf(
                    ...
                    "repostText"        to post.text,
                    "repostImg"         to post.imgUrl,

...
<div class="auth-wrap">
  <div class="auth-card">
    ...
    <p class="subtitle">Hesap oluştur</p>
    ...
    <div class="field">
      ...
      <input type="text" bind:value={displayName} placeholder="Adın Soyadın" />
    </div>
    ...
    <div class="field">
      <label>Şifre</label>
      <input type="password" bind:value={password} placeholder="En az 6 karakter" />
    </div>

    <button class="btn-primary" on:click={register} disabled={loading}>
...
.field input {
  ...
  border-radius: 12px; color: var(--on-bg); font-size: 15px; outline: none;
}
